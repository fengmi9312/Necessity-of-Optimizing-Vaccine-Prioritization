...
def analyze(expr_data):
    ...
    anal_data = {}
    task_names = ['necs_from_time_course_fixd_by_fatality_(param)']
    r0_amount = 40
    param_amount = 40
    ...
    for country in countries:
        ...
        for task_name, param_idx, target in itertools.product(task_names, range(param_amount), targets):
            ...
            for r0_idx in range(r0_amount):
                ...
                s_vol = expr_data[direct_effects_task_name][r0_idx][f's_{basic_params.country_abbr[country]}_{r0_idx}'][str(28)].to_numpy() * calc_params['populations']
