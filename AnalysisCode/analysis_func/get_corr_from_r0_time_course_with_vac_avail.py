...
def analyze(expr_data):
    ...
    anal_data = {}
    task_names = ['necs_from_time_course_fixd_with_vac_avail_(param)']
    r0_amount = 40
    param_amount = 40
    ...
    for country in countries:
        ...
        for task_name, param_idx, target in itertools.product(task_names, range(param_amount), targets):
            ...
            direct_effects_task_name = 'direct_effects_from_time_course_with_vac_avail_(param)'
            ...
            for r0_idx in range(r0_amount):
                ...
                direct_effects_coef = expr_data[direct_effects_task_name][r0_idx][f'{basic_params.country_abbr[country]}_{r0_idx}'][str(0)]
                ...
                s_vol = expr_data[direct_effects_task_name][r0_idx][f's_{basic_params.country_abbr[country]}_{r0_idx}'][str(0)].to_numpy() * calc_params['populations']
