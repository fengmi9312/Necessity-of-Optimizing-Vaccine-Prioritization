...
def draw(anal_data):
    ...
    region = 'other_locations'
    contacts = country_data['United States']['contacts'][region]
    ax = axes[0][0]
    plt.sca(ax)
    im = plt.imshow(contacts, origin = 'lower', cmap = 'Reds', vmax = 0.35, vmin = 0)
    ...
    plt.title('Other locations', fontsize = 15)
