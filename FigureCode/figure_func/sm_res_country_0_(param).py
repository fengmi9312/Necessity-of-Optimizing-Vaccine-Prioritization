# -*- coding: utf-8 -*-
"""
Created on Sat Apr 12 02:54:34 2025
...
import os
import sys
code_root, folder_level = os.path.dirname(os.path.abspath(__file__)), 2
    ...
    for col_type in ['flag', 'growth_rate','r0']:
        ...
        for country in countries:
            if col_type == 'flag':
                ...
                data_tmp = anal_data['necs_from_country_35'][col_type][country]
