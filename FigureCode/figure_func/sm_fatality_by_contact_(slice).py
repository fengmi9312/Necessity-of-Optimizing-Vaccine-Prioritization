...
def draw(anal_data):
    ...
    task_name = 'necs_from_fatality_by_contact_(coef_beta_1)'
    anal_name = 'necs_from_r0_fatality_by_contact'
    ...
    anal_name = 'corr_from_r0_fatality_by_contact'
    corr_opt, corr_wor = [], []
    for param_idx in range(40):
        sheet_name = f'{task_name}_{target}_{param_idx}_{basic_params.country_abbr[country]}'
        corr_opt.append(1 - anal_data[anal_name][sheet_name]['optimal_ind'])
        corr_wor.append(1 - anal_data[anal_name][sheet_name]['worst_ind'])
    ...
    for ax_idx in range(4):
        ...
        figure_setting.set_xylabel(ax, r'$R_0$', r'$\mathcal{N}_{\mathrm{d}}$ (%)', fontsize = label_fontsize, xlabel_coords = -0.15, ylabel_coords = -0.14)
        ...
        figure_setting.set_xylabel(ax, r'$R_0$', r'$\xi_{\mathrm{d}}^{\ast, \mathrm{opt}}$', fontsize = label_fontsize, xlabel_coords = -0.2, ylabel_coords = -0.2)
