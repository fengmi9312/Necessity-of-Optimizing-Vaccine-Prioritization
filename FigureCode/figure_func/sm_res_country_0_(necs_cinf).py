...
def draw(anal_data, **kwargs):
    ...
    landscape = anal_data['necs_from_r0_factor'][landscape_key][param_idx] * 100
    ...
    axins = ax.inset_axes([0.65, 0.65, 0.30, 0.27])
    axins.errorbar(
        r0_mean,
        necs_mean,
        xerr=[r0_mean - r0_lower, r0_upper - r0_mean],
