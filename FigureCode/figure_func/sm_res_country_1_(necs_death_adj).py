...
def draw(anal_data, **kwargs):
    ...
    landscape = anal_data['necs_from_r0_factor'][landscape_key][param_idx] * 100 / (country_data['United States']['populations'] @ country_data[country]['ifrs'])
