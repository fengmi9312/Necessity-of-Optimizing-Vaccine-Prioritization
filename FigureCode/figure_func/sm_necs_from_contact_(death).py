...
def draw(anal_data):
    ...
    ####################################################
    scale_prop = 10
    grid_attrs = [[{'pos': (0, 0), 'size': (30, 30)}, {'pos': (40, 0), 'size': (30, 30)}, {'pos': (80, 0), 'size': (30, 30)}], 
                  [{'pos': (32, 0), 'size': (2, 30)}, {'pos': (72, 0), 'size': (2, 30)}, {'pos': (112, 0), 'size': (2, 30)}]]
    ...
    for ax_idx, expr_param in enumerate(['1', '2', '13']):
        ...
        cbar.set_label(r'Necessity, $\phi$ (%)', labelpad = 2, fontsize = 10)
