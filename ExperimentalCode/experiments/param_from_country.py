...
def execute(expt_param, file_idx):
    ...
    for contact_type in ['none', 's', 'w', 'o', 'swo']:
        ...
        for param_idx, (a, b, c, d, alpha, beta) in enumerate(zip(a_samples, b_samples, c_samples, d_samples, alpha_samples, beta_samples)):
            ...
            if not cache_generator.check_cache(expt_param, file_idx, param_name):
                ...
                single_res = {'transmission_params': {'params': pd.Series([r0, b, alpha, beta, a, b, c, d, best_segment[0], best_segment[1]], 
