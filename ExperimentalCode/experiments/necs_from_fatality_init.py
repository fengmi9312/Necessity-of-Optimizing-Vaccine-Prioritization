# -*- coding: utf-8 -*-
"""
Created on Mon Dec 23 02:35:28 2024
...
def execute(expr_param, file_idx):
    ...
    for country_idx, country in enumerate(countries):
        ...
        for param_idx, param_val in enumerate(param_list):
            ...
            if expr_param.split('_')[1] == 'alpha': calc_params['ifrs'] = ifr_tmp * steady_d / (steady_c_arr @ ifr_tmp)
            ...
            if not cache_generator.check_cache(expr_param, file_idx, param_name):
                ...
                single_res = simu_once.simulate(calc_params, imm_params = ('delay', 700) if expr_param.split('_')[-1] == '1' else ('delay', 0), r0 = r0, optm_targets=['c', 'd'], c_perct = 0)
