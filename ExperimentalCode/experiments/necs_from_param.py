    ...
    for country_idx, country in enumerate(countries):
        ...
        for param_idx, param_val in enumerate(param_list):
            ...
            if not cache_generator.check_cache(expr_param, file_idx, param_name):
                ...
                if expr_param == 'delay': single_res = simu_once.simulate(calc_params, imm_params=('delay', param_val), r0 = r0, optm_targets=['c', 'd'])
                else: single_res = simu_once.simulate(calc_params, r0 = r0, **{expr_param: param_val}, optm_targets=['c', 'd'])
